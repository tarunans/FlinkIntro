...
public class InnerJoin {
	public static void main(String[] args) throws Exception {
		...
		// Read person.txt file and generate tuples out of each string read
		DataSet<Tuple2<Integer, String>> personSet = readDataSetFromFile(env, "input1", params);
		// Read location.txt file and generate tuples out of each string read
		DataSet<Tuple2<Integer, String>> locationSet = readDataSetFromFile(env, "input2", params);

		// join datasets on person_id, joined format will be <id, person_name, state>
	...
	private static DataSet<Tuple2<Integer, String>> readDataSetFromFile(final ExecutionEnvironment env, String input, final ParameterTool params){
		return env.readTextFile(params.get("input2")).
